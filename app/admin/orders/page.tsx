...
export default async function AdminOrdersPage() {
  ...
  return <main className="commerce-page"><header className="commerce-header"><a className="wordmark" href="/">AZZURA</a><nav><a href="/">Shop</a><a href="/admin/inventory">Inventory</a><a href="/admin/contacts">Contacts</a><a href="/account">My account</a></nav></header><section className="admin-layout"><p className="eyebrow">Azzura operations</p><h1>Orders &amp; fulfilment</h1>{authorized ? <OrderManager initialOrders={orders.results} /> : <div className="admin-notice"><h2>Admin access is not configured.</h2><p>Add the store owner email to activate this private order-management page.</p></div>}</section></main>;
}
